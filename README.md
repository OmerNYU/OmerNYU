...
*building somewhere between models, systems, and machines.*

<br>

<a href="https://omerhayat-portfolio.vercel.app/">
  <img src="https://img.shields.io/badge/Personal%20Website-111111?style=for-the-badge&logo=vercel&logoColor=white">
</a>
...
Most of my work lives somewhere around **ML engineering, robotics, full-stack systems, cloud infrastructure, and data-intensive software**.

I like problems where the model is only part of the story. Confidence matters. Evaluation matters. APIs, databases, state, deployment, failure handling, and human review matter too.

Sometimes the software controls a robot.

Sometimes the correct model output is **"I don't know."**
...
PitchMirror processes recorded pitches through a cloud pipeline built around **S3, Step Functions, ECS, and ML analysis**, then turns the resulting signals into structured coaching feedback.

`AWS` `ML` `TypeScript` `Next.js` `S3` `ECS` `Step Functions` `DynamoDB`

**Interesting bit:** inference is only one piece. Orchestration, storage, state, failure handling, and report generation are part of the product too.
...
**Interesting bit:** the output isn't *"AI thinks this is a bug."* It's executable evidence.
...
*Draws remain annoying.*

---

## 🔎 [Internship Monitor](https://github.com/OmerNYU/Internship-Monitor)

**A stateful internship discovery and monitoring engine.**
...
**Interesting bit:** built around explicit source health, deterministic decisions, durable state, retries, and safe failure modes.
